...
public final class Contract {
    ...
    static final String URI_EPISODES_OF_POCAST = "episode/podcast/";
    ...
    public static final class EpisodeTable implements BaseColumns {
        ...
        public static final Uri URI_OF_PODCAST = BASE_URI.buildUpon().appendPath(URI_EPISODES_OF_POCAST).build();
        public static final String  ID = "_id";
